...
export default function ExpenseForm(props) {
    ...
    const titleChangeHandler = (event) => {
        //target is the HTML prop that raised the event.
        //use the function to guarantee the prevSate desired value to the latest state snapshot. 
    ...
    return (<form className='expense-form' onSubmit={submitHandler}>
        <div className='new-expense__controls'>
            ...
            <div className='new-expense__control'>
                <label>Amount</label>
                <input type='date' min="2019-01-01" max="2024-12-31" value={userInput.enteredDate} onChange={dateChangeHandler} />
            </div>
        </div>
